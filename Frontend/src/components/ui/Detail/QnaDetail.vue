...
import type { QnaDetailResponse } from '@/types/api/qna';
import { selectQnaById, deleteQna } from '@/api/qna';
...
<template>
  ...
  <div v-else-if="qna" class="bg-white rounded-lg shadow-sm p-6">
    ...
    <div class="flex justify-end gap-2 pt-4 border-t">
      ...
      <BasicButton v-if="isAdmin" size="S" text="수정" @click="handleEdit" />
      <BasicButton v-if="isAdmin" size="S" text="삭제" @click="openDeleteModal" />
    </div>
  </div>
